...
<p></p> 
<p>This privacy policy governs your use of the software application App Name (â€œApplicationâ€) for mobile devices that was created by&nbsp;Developer Company Name.&nbsp;The Application is&nbsp;Basic description of the app (features, functionality and content)&nbsp;</p> 
<h4>&nbsp;</h4> 
...
<p>We will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. We will retain Automatically Collected information for up to 24 months&nbsp;and thereafter may store it in aggregate. If youâ€™d like us to delete User Provided Data that you have provided via the Application, please contact us at&nbsp;privacy@applicationsite.com&nbsp;and we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required in order for the Application to function properly.</p> 
<p>&nbsp;</p> 
